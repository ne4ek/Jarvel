...
def get_menu_task_filling_keyboard(data_completely_filled=False, go_to_main_menu=False):
    ...
    keyboard.inline_keyboard.extend([
        ...
        [InlineKeyboardButton(text="Изменить содержание задачи", callback_data="task_filling_change description")],
